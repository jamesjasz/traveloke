...
include '../proc/proc_edit_laju.php';
session_start();
	...
	<div class="content mt-2">
           ...
           <div class="col-lg-10">
                    <div class="card">
						...
						?>
						<form name="form1" method="post" action="../proc/proc_edit_laju.php">
                            <table class="table" border="0">
                               ...
                               placeholder="Date" required></th></th>
								...
								<tr>
									<th><input type="hidden" name="no_laju" value=<?php echo $_GET['no_laju'];?>></th>
