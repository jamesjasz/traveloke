...
include '../proc/proc_edit_booking.php';
session_start();
	...
	<div class="content mt-2">
           ...
           <div class="col-lg-10">
                    <div class="card">
                        ...
                        <div class="card-body">
						<form name="form1" method="post" action="../proc/proc_edit_booking.php">
                            <table class="table" border="0">
                               ...
                               placeholder="Date" required></th></th>
								...
								<tr>
									<th>Jumlah Kamar</th>
									<th><input type="text" name="jml_kamar" value="<?php echo $jml_kamar;?>"></th>
								</tr>
								<tr>
									<th>Lama Inap</th>
									<th><input type="text" name="lama_inap" value="<?php echo $lama_inap;?>"></th>
								</tr>
								<tr>
									<th><input type="hidden" name="no_booking" value=<?php echo $_GET['no_booking'];?>></th>
