...
include '../proc/proc_edit_kereta.php';
session_start();
	...
	<div class="content mt-2">
           ...
           <div class="col-lg-10">
                    <div class="card">
                        ...
                        <div class="card-body">
						<form name="form1" method="post" action="../proc/proc_edit_kereta.php">
                            <table class="table" border="0">
								<tr>
									<th>Nama Kereta</th>
									<th><input type="text" name="nama_k" value="<?php echo $nama_k;?>"></th>
								</tr>
								<tr>
									<th>Harga Kereta</th>
									<th><input type="text" name="harga_k" value="<?php echo $harga_k;?>"></th>
								</tr>
								<tr>
									<th><input type="hidden" name="id_kereta" value=<?php echo $_GET['id_kereta'];?>></th>
