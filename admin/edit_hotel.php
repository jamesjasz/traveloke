...
include '../proc/proc_edit_hotel.php';
session_start();
	...
	<div class="content mt-2">
           ...
           <div class="col-lg-10">
                    <div class="card">
                        ...
                        <div class="card-body">
						<form name="form1" method="post" action="../proc/proc_edit_hotel.php">
                            <table class="table" border="0">
								<tr>
									<th>Nama Hotel</th>
									<th><input type="text" name="nama_h" value="<?php echo $nama_h;?>"></th>
								</tr>
								<tr>
									<th>Foto</th>
								...
								<tr>
									<th>Daerah</th>
									<th><input type="text" name="daerah" value="<?php echo $daerah;?>"></th>
								</tr>
								<tr>
									<th>Lokasi</th>
									<th>
								...
								<tr>
									<th>Harga Hotel</th>
									<th><input type="text" name="harga_h" value="<?php echo $harga_h;?>"></th>
								</tr>
								<tr>
									<th><input type="hidden" name="no_hotel" value=<?php echo $_GET['no_hotel'];?>></th>
