...
include '../proc/proc_edit_pemesanan.php';
session_start();
	...
	<div class="content mt-2">
           ...
           <div class="col-lg-10">
                    <div class="card">
                        ...
                        <div class="card-body">
						<?php
						$querys = "SELECT * FROM penerbangan";	
						$results = mysqli_query($conn, $querys);
						$querys2 = "SELECT * FROM laju";	
						$results2 = mysqli_query($conn, $querys2);
						$querys3 = "SELECT * FROM seat_class";	
						$results3 = mysqli_query($conn, $querys3);
						?>
						<form name="form1" method="post" action="../proc/proc_edit_pemesanan.php">
                            <table class="table" border="0">
								...
								<tr>
									<th>No. Laju</th>
									<th>
									<select name="no_laju" class="form-control">
											<option value selected ></option>
								...
								<tr>
									...
									<th><input type="text" name="jml_pen" value="<?php echo $jml_pen;?>"></th>
								</tr>
								<tr>
									<th>No. Class</th>
									<th>
									<select name="no_class" class="form-control">
											<option value selected ></option>
								...
								<tr>
									<th>Tgl Pemesanan</th>
									<th><input type="date" name="tgl_pem" class="form-control"
                               placeholder="Date" required></th>
								</tr>
								<tr>
									<th><input type="hidden" name="no_pemesanan" value=<?php echo $_GET['no_pemesanan'];?>></th>
