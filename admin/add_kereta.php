	...
	<div class="content mt-2">
           ...
           <div class="col-lg-10">
                    <div class="card">
                        ...
                        <div class="card-body">
						<form name="form1" method="post" action="../proc/proc_add_kereta.php">
                            <table class="table" border="0">
								<tr>
									<th>ID Kereta</th>
									<th><input type="text" name="id_keretas"></th>
								</tr>
								<tr>
									<th>Nama Kereta</th>
									<th><input type="text" name="nama_ks"></th>
								</tr>
								<tr>
									<th>Harga Kereta</th>
									<th><input type="text" name="harga_ks"></th>
								</tr>
								<tr>
									<th><input type="hidden" name="id_kereta"></th>
