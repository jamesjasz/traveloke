	...
	<div class="content mt-2">
           ...
           <div class="col-lg-10">
                    <div class="card">
                        ...
                        <div class="card-body">
						<form name="form1" method="post" action="../proc/proc_add_class.php">
                            <table class="table" border="0">
								<tr>
									<th>Nama Class</th>
									<th><input type="text" name="nama_classz"></th>
								</tr>
								<tr>
									<th>Transportasi</th>
									<th>
										<select name="transportasiz">
								...
								<tr>
									<th>Harga Seat</th>
									<th><input type="text" name="harga_sz"></th>
								</tr>
								<tr>
									<th><input type="hidden" name="no_class"></th>
