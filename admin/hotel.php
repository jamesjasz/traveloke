           ...
           <div class="col-lg-10">
                    <div class="card">
                        <div class="card-header">
                            <strong class="card-title float-right"><a href="add_hotel.php"><button type="button" class="btn btn-primary">Add</button></a></strong>
                        </div>
                        <div class="card-body">
                            <table class="table">
                              <thead class="thead-dark">
                                <tr>
                                  <th scope="col">No. Hotel</th>
                              ...
                              <tbody>
								...
								if($result-> num_rows > 0) {
									while ($row = $result-> fetch_assoc()) {
										echo "<tr><th scope='row'>". $row["no_hotel"] ."</th><th>". $row["nama_hotel"] ."</th><th>". $row["foto"] ."</th><th>". $row["daerah"] ."</th><th>". $row["lokasi"] ."</th><th>". $row["harga_h"] ."</th><th><a href='edit_hotel.php?no_hotel=$row[no_hotel]'>Edit</a> | <a href='../proc/proc_delete_hotel.php?no_hotel=$row[no_hotel]'onClick=\"return confirm('Are you sure you want to delete?')\")>Delete</a></th></tr>";
									}
									echo "</table>";
								}else {
