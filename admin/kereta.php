           ...
           <div class="col-lg-10">
                    <div class="card">
                        <div class="card-header">
                            <strong class="card-title float-right"><a href="add_kereta.php"><button type="button" class="btn btn-primary">Add</button></a></strong>
                        </div>
                        <div class="card-body">
                            <table class="table">
                              ...
                              <tbody>
								...
								if($result-> num_rows > 0) {
									while ($row = $result-> fetch_assoc()) {
										echo "<tr><th scope='row'>". $row["id_kereta"] ."</th><th>". $row["nama_k"] ."</th><th>". $row["harga_k"] ."</th><th><a href='edit_kereta.php?id_kereta=$row[id_kereta]'>Edit</a> | <a href='../proc/proc_delete_kereta.php?id_kereta=$row[id_kereta]'onClick=\"return confirm('Are you sure you want to delete?')\")>Delete</a></th></tr>";
									}
									echo "</table>";
								}else {
