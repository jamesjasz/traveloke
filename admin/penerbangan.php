           ...
           <div class="col-lg-10">
                    <div class="card">
                        <div class="card-header">
                            <strong class="card-title float-right"><a href="add_penerbangan.php"><button type="button" class="btn btn-primary">Add</button></a></strong>
                        </div>
                        <div class="card-body">
                            <table class="table">
                              ...
                              <tbody>
								...
								if($result-> num_rows > 0) {
									while ($row = $result-> fetch_assoc()) {
										echo "<tr><th scope='row'>". $row["no_penerbangan"] ."</th><th>". $row["id_pesawat"] ."</th><th>". $row["tgl_berangkat"] ."</th><th>". $row["jam"] ."</th><th>" . $row["durasi"] ."</th><th>". $row["no_tujuan"] ."</th><th><a href='edit_penerbangan.php?no_penerbangan=$row[no_penerbangan]'>Edit</a> | <a href='../proc/proc_delete_penerbangan.php?no_penerbangan=$row[no_penerbangan]'onClick=\"return confirm('Are you sure you want to delete?')\")>Delete</a></th></tr>";
									}
									echo "</table>";
								}else {
