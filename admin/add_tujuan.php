	...
	<div class="content mt-2">
           ...
           <div class="col-lg-10">
                    <div class="card">
                        ...
                        <div class="card-body">
						<form name="form1" method="post" action="../proc/proc_add_tujuan.php">
                            <table class="table" border="0">
								<tr>
									<th>Tempat Awal</th>
									<th><input type="text" name="tmpt_as"></th>
								</tr>
								<tr>
									<th>Tempat Tujuan</th>
									<th><input type="text" name="tmpt_ts"></th>
								</tr>
								<tr>
									<th>Harga Tujuan</th>
									<th><input type="text" name="harga_ts"></th>
								</tr>
								<tr>
									<th><input type="hidden" name="no_tujuan"></th>
