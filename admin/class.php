           ...
           <div class="col-lg-10">
                    <div class="card">
                        <div class="card-header">
                            <strong class="card-title float-right"><a href="add_class.php"><button type="button" class="btn btn-primary">Add</button></a></strong>
                        </div>
                        <div class="card-body">
                            <table class="table">
                              ...
                              <tbody>
								...
								if($result-> num_rows > 0) {
									while ($row = $result-> fetch_assoc()) {
										echo "<tr><th scope='row'>". $row["no_class"] ."</th><th>". $row["nama_class"] ."</th><th>". $row["transportasi"] ."</th><th>". $row["harga_s"] ."</th><th><a href='edit_class.php?no_class=$row[no_class]'>Edit</a> | <a href='../proc/proc_delete_class.php?no_class=$row[no_class]'onClick=\"return confirm('Are you sure you want to delete?')\")>Delete</a></th></tr>";
									}
									echo "</table>";
								}else {
