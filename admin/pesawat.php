           ...
           <div class="col-lg-10">
                    <div class="card">
                        <div class="card-header">
                            <strong class="card-title float-right"><a href="add_pesawat.php"><button type="button" class="btn btn-primary">Add</button></a></strong>
                        </div>
                        <div class="card-body">
                            <table class="table">
                              ...
                              <tbody>
								...
								if($result-> num_rows > 0) {
									while ($row = $result-> fetch_assoc()) {
										echo "<tr><th scope='row'>". $row["id_pesawat"] ."</th><th>". $row["nama_maskapai"] ."</th><th>". $row["foto"] ."</th><th>". $row["harga_p"] ."</th><th><a href='edit_pesawat.php?id_pesawat=$row[id_pesawat]'>Edit</a> | <a href='../proc/proc_delete_pesawat.php?id_pesawat=$row[id_pesawat]'onClick=\"return confirm('Are you sure you want to delete?')\")>Delete</a></th></tr>";
									}
									echo "</table>";
								}else {
