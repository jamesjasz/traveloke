                              ...
                              <tbody>
								...
								if($result-> num_rows > 0) {
									while ($row = $result-> fetch_assoc()) {
										echo "<tr><th scope='row'>". $row["no_booking"] ."</th><th>". $row["no_hotel"] ."</th><th>". $row["tgl_booking"] ."</th><th>". $row["jumlah_kamar"] ."</th><th>". $row["lama_inap"] ."</th><th><a href='edit_booking.php?no_booking=$row[no_booking]'>Edit</a> | <a href='../proc/proc_delete_booking.php?no_booking=$row[no_booking]'onClick=\"return confirm('Are you sure you want to delete?')\")>Delete</a></th></tr>";
									}
									echo "</table>";
								}else {
